...
public class FastUnitControl {
        ...
        public LInstruction build(LAssembler builder){
            ...
            return new LInstruction() {
                ...
                public void run(LExecutor exec){
                    ...
                    LogicAI ai = LExecutor.UnitControlI.checkLogicAI(exec, unit);
                    
                    if(unit != null && ai != null){
                        ai.controlTimer = LogicAI.logicControlTimeout;
                        
                        switch(type){
                            case itemTake:
                                Building from = p1Var.building();
                                Item item = p2Var.obj() instanceof Item ? (Item)p2Var.obj() : null;
                                int amount = (int)p3Var.numi();
                            ...
                            case itemDrop:
                                Building to = p1Var.building();
                                int dropAmount = (int)p2Var.numi();
                                
                                if(unit.item() != null) {
                                    if(to == null || p1Var.obj() == air){
                                        if(!net.client()) {
                                            unit.clearItem();
                                        }
                            ...
                            case payDrop:
                                float dropX = p1Var.numf();
                                float dropY = p2Var.numf();
    ...
    public enum FastUnitControlType {
        ...
        public static final FastUnitControlType[] all = values();
